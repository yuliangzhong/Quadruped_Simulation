...
execute_process(
  COMMAND "/usr/bin/git" show-ref "077b65e0cf3e22ee4f588783e319b19b0a608065"
  WORKING_DIRECTORY "/home/ubuntu/CMM/a2-yuliangzhong/build/_deps/nanovg-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/077b65e0cf3e22ee4f588783e319b19b0a608065")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "077b65e0cf3e22ee4f588783e319b19b0a608065")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "077b65e0cf3e22ee4f588783e319b19b0a608065")
endif()
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/memononen/nanovg'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/home/ubuntu/CMM/a2-yuliangzhong/build/_deps/nanovg-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/ubuntu/CMM/a2-yuliangzhong/build/_deps/nanovg-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
